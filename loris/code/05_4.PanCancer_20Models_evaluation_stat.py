...
#List without XGBoost, CatBoost and LightGBM
MLM_list= ['LLR6', 'LR5noTMB', 'TMB', 'LogisticRegression', 'DecisionTree','RF6', 'RF16_NBT',
              'AdaBoost', 'SupportVectorMachineRadial',
             'kNearestNeighbourhood', 'NeuralNetwork1', 'NeuralNetwork2', 'NeuralNetwork3', 'NeuralNetwork4',
             'GaussianProcess']
...
#List without the ones that didnt work
MLM_list1=['TMB', 'DecisionTree', 'RF6', 'RF16_NBT', 'RandomForest',
            'RF16_NBT'] # data scaling: None

MLM_list2=['LLR6', 'LR5noTMB', 'LLR5noPSTH', 'LogisticRegression','GBoost', 'AdaBoost', 'HGBoost', 'XGBoost',
           'CatBoost', 'LightGBM','SupportVectorMachineRadial',
           'kNearestNeighbourhood','NeuralNetwork1','NeuralNetwork2','NeuralNetwork3','NeuralNetwork4',
           'GaussianProcess', "TabNet"] # StandardScaler
